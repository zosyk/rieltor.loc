<div class="">
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25"
                ...
                <div class="sl-slide-inner">
                    <div class="bg-img"
                         style="background-image: url('<?= \frontend\components\Common::getImageAdvert($row)[0] ?>')" )
                    ">
                </div>
    ...
    <nav id="nav-dots" class="nav-dots">
        ...
        <?
        if ($count_general > 1):
            foreach (range(1, $count_general-1) as $line):
                ?>
                <span></span>
                <?
            endforeach;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <?= \yii\helpers\Html::dropDownList('Price', '',
                                ['Price', '$150,000 - $200,000', '$200,000 - $250,000', "$250,000 - $300,000", '$300,000 - above'],
                                ['class' => 'form-control']) ?>
                        </div>
                        <div class="col-lg-3 col-sm-4">
